...
def predict(speaker_list, model_path, model_name, out_path):
    ...
    output_phone_sequence(phone_wise, out_path, 2)
...
if __name__ == '__main__':
    ...
    test_data_mfcc = utility.read_data(sys.argv[1], 'mfcc', 'test')
    test_data_fbank = utility.read_data(sys.argv[1], 'fbank', 'test')
    ...
    predict(speaker_list, model_path, model_name, sys.argv[2])
